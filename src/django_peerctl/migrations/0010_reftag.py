...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='auditlog',
            name='event',
            field=models.CharField(choices=[('peer_session-request', 'Peering Request'), ('peer_session-add', 'Session Add'), ('peer_session-del', 'Session Delete'), ('peer_session-mod', 'Session Modify'), ('policy-mod', 'Policy Modify'), ('email', 'Email')], max_length=255),
        ),
        migrations.AlterField(
            model_name='emaillog',
            name='net',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='qset_email_log', to='django_peerctl.network'),
        ),
        migrations.AlterField(
            model_name='emaillog',
            name='origin',
            field=models.CharField(choices=[('peer_session-workflow', 'Peering Session Workflow'), ('bulk-email', 'Notification Email')], max_length=255),
        ),
        migrations.AlterField(
            model_name='network',
            name='asn',
        ...
        migrations.AlterField(
            model_name='peersession',
            name='port',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='peer_session_qs', to='django_peerctl.port'),
        ),
        migrations.AlterField(
            model_name='physicalport',
            name='device',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='physical_port_qs', to='django_peerctl.device'),
        ),
        migrations.AlterField(
            model_name='portinfo',
            name='net',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='port_info_qs', to='django_peerctl.network'),
        ),
